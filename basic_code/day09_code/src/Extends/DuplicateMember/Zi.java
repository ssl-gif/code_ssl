...
public class Zi extends Fu {
    ...
    public void method1() {
        ...
        // 重名的静态成员变量、方法在本类普通成员方法中的使用：优先使用重名的子类成员，默认使用隐含的子类类名修饰，一般省略不写。
    ...
    public static void method2() {
        ...
        // 重名的普通成员变量、方法在本类静态成员方法中的使用：静态不能访问本类的非静态内容。所以重名的子类成员、父类成员，均不可使用。

        // 重名的静态成员变量、方法在本类静态成员方法中的使用：优先使用重名的子类成员，默认使用隐含的子类类名修饰，一般省略不写。
        System.out.println(staticNum);
        staticMethod();
